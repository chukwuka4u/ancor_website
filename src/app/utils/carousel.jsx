...
const OwlCarousel = dynamic(() => import('react-owl-carousel'), {
  ...
  export default function Slider() {
    return (
      <div className=" flex items-center h-[500px] w-[300px] ml-10">
        <OwlCarousel className="owl-theme" {...options}>
          <div className="flex flex-col justify-between h-[250px] w-[300px] py-[10px]">
              <div className="flex items-center h-[65px]">
                  ...
                  alt=""
                    ...
                    width={62}
                    height={62}
                    className="w-[62px] h-[62px] object-contain round mr-8"
                    />
